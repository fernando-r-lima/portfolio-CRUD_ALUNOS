...
namespace ProjetoAlunos2.Data
{
    public class SeedingService
    {
        ...
        public void PopularDb()
        {
            ...
            Aluno a7 = new Aluno(7, "Fabiano", "Santos", new DateTime(1993, 7, 8), "santos-fabiano@gmail.com");
            Aluno a8 = new Aluno(8, "Augusto", "Souza", new DateTime(1994, 3, 9), "augusto@gmail.com");
            Aluno a9 = new Aluno(9, "Marcela", "Medeiros", new DateTime(1995, 11, 23), "marcela-med@gmail.com");
            Aluno a10 = new Aluno(10, "Rafael", "Aguiar da Nobrega", new DateTime(1994, 5, 14), "rafa.aguiar@gmail.com");
            Aluno a11 = new Aluno(11, "Luiz Henrique", "Justino de Almeida", new DateTime(1994, 6, 8), "henrique.lu94@gmail.com");
            Aluno a12 = new Aluno(12, "Flaviana", "Souza", new DateTime(1993, 12, 10), "souzaflaviana@gmail.com");
