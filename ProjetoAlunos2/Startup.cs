...
namespace ProjetoAlunos2
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ProjetoAlunos2Context>(options =>
                    options.UseMySql(Configuration.GetConnectionString("ProjetoAlunos2Context"), builder =>
